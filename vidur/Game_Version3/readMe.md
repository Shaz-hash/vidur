...
This document describes the current Game Version 3 implementation in the Python GV3 pipeline. The main implementation lives under `vidur/mcts/Game_Versions/Game_Version3/`. Use this to learn about the GV3 game physics, thats it. 
