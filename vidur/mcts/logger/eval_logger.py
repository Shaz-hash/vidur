...
class EvalArenaStepLogger:
    ...
    def log_step(self, row: Dict[str, Any]) -> None:
        ...
        full = {
            ...
            "mcts_root_value_controller": "" if row.get("mcts_root_value_controller", None) is None else _safe_float(row.get("mcts_root_value_controller")),
            "mcts_root_prior_json": str(row.get("mcts_root_prior_json", "[]")),
