...
class EvaluationGroup:
    ...
    # NEW stop criterion
    arena_time_limit_sec: float = 2.0
...
class MultipleProcessTrainingConfig:
    ...
    roots_per_generation: int = 20

    adv_iterations_per_root: int = 1000
    cont_iterations_per_root: int = 1000
    max_batch_size: int = 256

    train_steps_per_generation: int = 10
    train_batch_size: int = 256

    history_seed: int = 0
    history_hops_per_worker: Tuple[int, ...] = tuple(range(20))  # length must equal num_processes
    max_forced_hops_per_root: int = 1024
    ...
    replay_capacity_samples: int = 12000
    replay_max_cached_shards: int = 1200
    ...
    worker_result_timeout_sec: int = 3600
