...
build_native_module() {
  ...
  local py="${VENV_DIR}/bin/python"
  local native_dir="${REPO_DIR}/vidur/mcts/Game_Versions/Game_Version3/native"
...
import platform
import torch
from vidur.mcts.Game_Versions.Game_Version3.Network.client.run_task import main as client_main
from vidur.mcts.Game_Versions.Game_Version3.Network.network_config import DEFAULT_NETWORK_CONFIG
from vidur.mcts.Game_Versions.Game_Version3.config import DEFAULT_MULTIPROCESS_TRAINING_CONFIG
