...
class VidurMCTS:
    ...
    def get_controller_action_key(self, action: ControllerAction) -> tuple:
        ...
        # Canonicalize by simulator effect, not by the heuristic path that produced
        # the action. SJF/EDF/LST can produce identical allocations, and those must
        # share one MCTS child rather than receiving separate noisy value estimates.
