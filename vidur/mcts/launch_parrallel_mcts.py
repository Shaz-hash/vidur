...
# # depth_per_process = [0, 20, 120, 140, 160, 100 ,0, 20, 120, 140, 160, 100, 31, 89]
# depth_per_process = [10]
...
#             # First half uses QPS[0], second half uses QPS[1]
#             qps_value = QPS[0] if i <= NUM_RUNS // 2 else QPS[1]

#             # Simulation depth: first half = 1, second = 2
#             sim_depth = "1" if i <= NUM_RUNS // 2 else "2"
...
#                 "--mcts_iterations", "50000",
#                 "--mcts_simulation_random_tries", "1",
#                 "--mcts_simulation_depth", sim_depth,
#                 "--mcts_interval_request_size", "512",
#                 "--mcts_maximum_qps", str(qps_value),
#                 "--mcts_min_request_tokens", "512",
#                 "--mcts_exploration_constant", "1.7",
#                 "--mcts_max_branching", "10",
#                 "--mcts_max_request_tokens", "3072",
#                 "--mcts_prefill_profile", "simulator_output/prefill_profile.csv",
#                 "--mcts_prefill_slos", "4.0",
#                 "--mcts_decode_slos", "100",
#                 "--mcts_log_csv", BASE_CSV,
#                 "--replica_config_model_name", "meta-llama/Meta-Llama-3-8B",
#                 "--replica_config_device", "a100",
#                 "--replica_config_network_device", "a100_dgx",
