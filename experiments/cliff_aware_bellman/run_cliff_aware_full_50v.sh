...
BASE=$PWD/simulator_output/GV3_Agent/BellmanConvergence/cliff_aware_full_50v
LOG=$BASE.log
MON=$BASE.monitor.log
CACHE=$PWD/simulator_output/GV3_Agent/BellmanConvergence/_cliff_feature_cache_full

EXTRA=$(printf '{"classical_backend":"cliff_aware","cliff_feature_num_processes":64,"cliff_feature_chunk_records":2048,"cliff_feature_cache_dir":"%s","cliff_worker_threads":1,"bootstrap_batch_roots":128,"bootstrap_child_batch_size":8192,"target_worker_threads":1,"n_jobs":24,"max_trainable_params":150000,"bootstrap_clip_min":-5.0,"bootstrap_clip_max":0.0}' "$CACHE")
