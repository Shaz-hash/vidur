#!/usr/bin/env python3
"""
Inspect the v4 state-local feature vector for one stored controller root sample.
...
/home/shazer/Desktop/Research/Vidur/vidur/.venv/bin/python3 \
  -m experiments.new_features_v1.test_and_analysis.analysis_of_one_sample_features \
  --seed 12345

Default output directory:

/home/shazer/Desktop/Research/Vidur/vidur-classical-search/simulator_output/GV3_Agent/feature_analysis/one_sample_features
"""
...
DEFAULT_OUTPUT_DIR = (
    REPO_ROOT
    / "simulator_output/GV3_Agent/feature_analysis/one_sample_features"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Analyze v4 features for one stored root sample")
