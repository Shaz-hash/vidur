...
from ..root_storage import refresh_root_objective_stats
...
def generate_child_states(
    *,
    ...
    # Keep child-transition rewards consistent with repaired parent targets.
    refresh_root_objective_stats(mcts._env, root_parent_state)
