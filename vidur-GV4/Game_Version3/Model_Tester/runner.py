...
# Optional hooks used by experiment wrappers. They leave the standalone tester
# unchanged while allowing AlphaGoZero to attach replay and arena context.
...
def _build_bundle(cfg: ModelTesterConfig) -> _RunnerBundle:
    ...
    if bool(getattr(explore_cfg, "native_mcts_enabled", False)) and str(cfg.model_kind) != "classical_joblib":
        from vidur.Game_Version3_Cpp import mcts_native_gv2 as _mcts_native_gv2
