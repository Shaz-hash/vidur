...
def _agz_env_prefix() -> str:
    keys = (
        ...
        "VIDUR_GV3_COMPUTE_INPUT_FILE",
        "VIDUR_GV3_ATTENTION_INPUT_FILE",
        "VIDUR_GV3_PREDICTOR_CACHE_DIR",
        "VIDUR_GV3_PREFILL_PROFILE_PATH",
        "OMP_NUM_THREADS",
...
def sync_code(args: argparse.Namespace) -> None:
    ...
    excludes = [
        ...
        "--exclude", "cache",
        "--exclude", "cache/",
        "--exclude", "vidur/Profiler/A100_TP1_MEW1_GPU2/artifacts/cache/",
        "--exclude", "vidur/Profiler/A100_TP1_MEW1_GPU2/artifacts/raw_cache/",
