...
| Runtime reference | CPython `3.12.13`, Arm64 native build, and calibrated mew1 GPU2 A100 TP1 predictor/profile SHA-256 `d593b054...920b7`. |
...
| Role | SSH alias | Public IP | EC2 instance ID | Designated work |
| --- | --- | --- | --- | --- |
| XL coordinator | `bellman-classical-exp3-xl` | `54.165.94.14` | `i-02f4e2ed0c772c534` | Replay ingestion, DNN training, distributed evaluation, and promotion. |
| Worker 1 | `bellman-classical-exp3-worker-1` | `35.153.70.245` | `i-0e90f4613c2b78ad7` | Self-play and distributed evaluation. |
| Worker 2 | `bellman-classical-exp3-worker-2` | `52.90.47.245` | `i-01b2eec16c274294e` | Self-play and distributed evaluation. |
| Worker 3 | `bellman-classical-exp3-worker-3` | `100.31.72.34` | `i-014435c9a4b58835c` | Self-play and distributed evaluation. |
| Worker 4 | `bellman-classical-exp3-worker-4` | `54.87.82.116` | `i-0d753bcfb659402f3` | Self-play and distributed evaluation. |
| Worker 5 | `bellman-classical-exp3-worker-5` | `18.234.72.197` | `i-0c40daae4c3066233` | Self-play and distributed evaluation. |
| Worker 6 | `bellman-classical-exp3-worker-6` | `18.209.109.219` | `i-01ffb145e88eba394` | Self-play and distributed evaluation. |
| Worker 7 | `bellman-classical-exp3-worker-7` | `184.73.31.3` | `i-05bf2fbcc92c0ed4c` | Self-play and distributed evaluation. |
| Worker 8 | `bellman-classical-exp3-worker-8` | `174.129.70.145` | `i-00b262b9fc57d1635` | Self-play and distributed evaluation. |
