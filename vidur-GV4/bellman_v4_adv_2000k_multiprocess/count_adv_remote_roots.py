"""Fast remote root-count status for multi-server GV3 adversary-root generation.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--hosts", default=None, help="Comma-separated SSH hosts. Defaults to adversary workers 5-8.")
